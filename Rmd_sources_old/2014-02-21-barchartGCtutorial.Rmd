...
```{r include=FALSE}
opts_chunk$set(tidy=FALSE,fig.width=3.5,fig.height=3.5)
```
...
To get  abar chart that looks like a visual "copy" o fth erow percentages, set the argument `flat` to `TRUE`:
