...
# HSW comments:  apparently the above line is to be place dinto my R.xml.  So far I can't ge this to work,
# but I'll leave this plugin in the directory and think about it some more.  -- May 8, 2014
